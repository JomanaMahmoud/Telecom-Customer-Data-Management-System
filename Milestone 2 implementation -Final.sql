...
VALUES 
(101, 'John', 'Doe', 'john.doe@example.com', '123 Elm Street', '1990-01-01'),
(102, 'Jane', 'Smith', 'jane.smith@example.com', '456 Oak Avenue', '1985-05-15'),
(103, 'Alice', 'Brown', 'alice.brown@example.com', '789 Pine Road', '1992-09-23');
INSERT INTO customer_account (mobileNo, pass, balance, account_type, start_date, status, points, nationalID)
VALUES 
('01012345678', 'password1', 100.0, 'prepaid', '2024-01-01', 'active', 10, 101),
('01098765432', 'password2', 50.0, 'postpaid', '2024-02-01', 'onhold', 20, 102),
('01122334455', 'password3', 75.0, 'pay-as-you-go', '2024-03-01', 'active', 15, 103);
INSERT INTO Service_plan (name, price, SMS_offered, minutes_offered, data_offered, description)
VALUES 
('Basic Plan', 50, 100, 200, 1, 'Affordable for basic needs'),
('Premium Plan', 100, 500, 1000, 5, 'Great for frequent users'),
('Unlimited Plan', 200, 9999, 9999, 50, 'Unlimited access');
INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES 
('01012345678', 1, '2024-01-10', 'active'),
('01098765432', 2, '2024-02-15', 'onhold'),
('01122334455', 3, '2024-03-20', 'active');
INSERT INTO Plan_Usage (start_date, end_date, data_consumption, minutes_used, SMS_sent, mobileNo, planID)
VALUES 
('2024-01-10', '2024-01-20', 0.5, 50, 25, '01012345678', 1),
('2024-02-15', '2024-02-25', 2, 100, 75, '01098765432', 2),
('2024-03-20', '2024-03-30', 10, 500, 500, '01122334455', 3);
INSERT INTO Payment (amount, date_of_payment, payment_method, status, mobileNo)
VALUES 
(50.0, '2024-01-15', 'credit', 'successful', '01012345678'),
(100.0, '2024-02-20', 'cash', 'pending', '01098765432'),
(200.0, '2024-03-25', 'credit', 'successful', '01122334455');
...
VALUES 
(50.00, 'EGP', '2024-01-15', 101, '01012345678'),
(100.00, 'EGP', '2024-02-20', 102, '01098765432'),
(200.00, 'EGP', '2024-03-25', 103, '01122334455');
INSERT INTO transfer_money (walletID1, walletID2, amount, transfer_date)
VALUES 
(1, 2, 25.00, '2024-03-01'),
(2, 3, 50.00, '2024-03-05');
INSERT INTO Benefits (description, validity_date, status, mobileNo)
VALUES 
('Free 100 SMS', '2024-04-30', 'active', '01012345678'),
('Bonus Data', '2024-05-31', 'active', '01098765432'),
('Extra Minutes', '2024-06-30', 'expired', '01122334455');
...
VALUES 
(1, '123 Market Street', '9 AM - 9 PM'),
(2, '456 Tech Avenue', '10 AM - 8 PM');
INSERT INTO E_shop (shopID, URL, rating)
VALUES 
(3, 'www.fashionhub.com', 5);
INSERT INTO Voucher (value, expiry_date, points, mobileNo, redeem_date, shopID)
VALUES 
(100, '2024-12-31', 10, '01012345678', '2024-01-20', 1),
(200, '2024-12-31', 20, '01098765432', '2024-02-20', 2),
(300, '2024-12-31', 30, '01122334455', '2024-03-25', 3);
INSERT INTO Technical_support_ticket (mobileNo, issue_description, priority_level, status)
VALUES 
('01012345678', 'Network Issue', 1, 'Open'),
('01098765432', 'Billing Problem', 2, 'In progress'),
('01122334455', 'Data Issue', 3, 'Resolved');
